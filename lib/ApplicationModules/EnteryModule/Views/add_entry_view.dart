...
import 'package:merriage_management/ApplicationModules/InvoiceModule/Views/invoice_view.dart';
...
class _AddEnteryViewState extends State<AddEnteryView> {
  ...
  void initState() {
    ...
    lumSumCustomer.text = "0";
    maleCustomer.text = "0";
    femaleCustomer.text = "0";
    flowerDecoration.text = "0";
    soundSystem.text = "0";
    fanQuantity.text = "0";
    fanPrice.text = "0";
    fanTotal.text = "0";
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextEditField(
                      ...
                      onChanged: (value) {
                        if (value != "") {
                          int price = (int.parse(perHead.text) *
                              int.parse(value)) +
                        ...
                        onPressed: () async {
                          ...
                          if (selectedType.isNotEmpty &&
                            ...
                            await FirebaseFirestore.instance
                              ...
                              description.text = "";
                              Get.to(
                                InVoiceView(entryModel: entryModel),
